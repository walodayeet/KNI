...
export default function BrevoForm() {
  ...
  return (
    <>
      ...
      {/* Form Container */}
      <div className='sib-form consultation-form' style={{ textAlign: 'center' }}>
            ...
            >
                      ...
                      <div>
                        ...
                        <div className='entry__choice'>
                          <label className='checkbox__label'>
                            ...
                            >
                              {t('searchOptions.referred') || 'Được giới thiệu từ người quen'}
                            </span>
                          </label>
                        </div>
                      </div>
              ...
              >
                <div className='sib-form-message-panel__text sib-form-message-panel__text--center'>
                  ...
                  <span className='sib-form-message-panel__inner-text'>
                    {t('successMessage') || 'Đăng ký thành công, nhớ check Zalo của bạn nhé!'}
                  </span>
                </div>
              </div>
      ...
      <Script id='brevo-form-script' strategy='afterInteractive'>
        {`
          ...
          window.REQUIRED_ERROR_MESSAGE = "${t('requiredError') || 'Đừng bỏ trống tui :('}";
      ...
      <Script id='consultation-form-handler' strategy='afterInteractive'>
        {`
